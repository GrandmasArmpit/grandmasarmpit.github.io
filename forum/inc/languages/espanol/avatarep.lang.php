...
$l['registration_date'] = "Registro: ";
$l['reputation'] = "Reputación: ";
$l['total_threads'] = "Temas: ";
$l['total_posts'] = "Mensajes: ";
$l['lastvisit'] = "Última visita: ";
$l['warning_level'] = "Nivel de advertencia: ";
$l['online_status'] = "Estado: ";
$l['avatarep_user_profile'] = "Ver perfil";
$l['avatarep_user_sendpm'] = "Enviar MP";
$l['find_threads'] = "Temas del usuario";
$l['find_posts'] = "Mensajes del usuario";
$l['guest'] = 'Invitado';
